...
export const quote = {
  ...
  pricing: {
    ...
    parts: [
      {
        tag: "Phase 1 — Architecture & Design",
        subtag: "Fixed price — excl. VAT",
        title: "Detailed Technical Architecture",
        body: "A fixed-fee engagement producing the full architecture blueprint, capacity plan and firm cost model for build, running and maintenance.",
        price: "from 180 000 SEK",
        unit: "fixed — excl. VAT",
        rows: [
          { label: "Deliverable", value: "Architecture blueprint, roadmap and firm cost model." },
          { label: "Payment", value: "On delivery of the blueprint. 30 calendar days' terms." },
          { label: "Credit", value: "Credited in full against the build engagement if commissioned within 60 days." },
        ],
      },
      {
        tag: "Phase 2 — Build & Implementation",
        subtag: "Time & Materials — excl. VAT",
        title: "Design, Build & Launch",
        body: "Building the platform to your launch milestones. Delivered in phases against the roadmap, billed monthly on actual hours with a detailed time report.",
        price: "1 790 SEK",
        unit: "per hour, excl. VAT",
        rows: [
          { label: "Indicative", value: "Order of magnitude 2.5–4 MSEK to first launch; firmed up in Phase 1." },
          { label: "Billing", value: "Monthly, on actual hours worked, against agreed milestones." },
          { label: "Scope", value: "Ingest, processing, delivery, apps, monetization and data layers." },
        ],
      },
      {
        tag: "Phase 3 — Operation & Maintenance",
        subtag: "Recurring — excl. VAT",
        title: "Managed Operation & Maintenance",
        body: "Eyevinn operates and maintains the running platform: monitoring, updates, incident response and SLA. Infrastructure billed at cost — no platform margin.",
        price: "from 45 000 SEK / mo",
        unit: "managed ops — excl. VAT",
        rows: [
          { label: "Infrastructure", value: "OSC consumption billed at cost; scales with concurrency and usage." },
          { label: "Indicative infra", value: "~30 000–120 000 SEK / mo depending on peak concurrency." },
          { label: "Included", value: "Monitoring, updates, incident response, SLA and a monthly report." },
        ],
      },
    ],
    footnote:
      "All prices exclude VAT and are indicative until the Phase 1 architecture fixes scope, target concurrency and content volume. Infrastructure (Open Source Cloud) is billed at cost with no platform margin. On-site travel outside Stockholm invoiced at cost. Payment terms 30 calendar days.",
  },
